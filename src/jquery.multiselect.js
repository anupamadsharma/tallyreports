    ...
    MultiSelect.prototype = {
        ...
        load: function() {
            ...
            placeholder.on( 'mousedown', function( event ){
                ...
                var _statusMSActive = optionsWrap.closest('.ms-options-wrap').hasClass('ms-active');
                if(_statusMSActive == true) {
                    showButton();
                }else{
                   hideButton();
                }
            ...
            if( instance.options.selectAllITV ) {
                optionsList.before('<a href="#" class="ms-selectall global newtab"><i class="glyphicon glyphicon-refresh"></i></a>');
                optionsList.before('<button type="button" class="btn btn-default btn-lg"><span class="glyphicon glyphicon-star"></span> Star </button>');
            }
